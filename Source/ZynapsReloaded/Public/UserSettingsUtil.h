...
#include "UserSettingsUtil.generated.h"

// Log category
DECLARE_LOG_CATEGORY_EXTERN(LogUserSettingsUtil, Log, All);

/**
 * A class with utility methods to manage user game settings.
 */
UCLASS()
class ZYNAPSRELOADED_API UUserSettingsUtil : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
